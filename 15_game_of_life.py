...
class Grid:
    ...
    def initialize_world(self):
        ...
        #offset = 50
        #glider = {
        #    Cell(offset + 1, offset + 0),
        #    Cell(offset + 2, offset + 1),
        #    Cell(offset + 0, offset + 2),
        #    Cell(offset + 1, offset + 2),
        #    Cell(offset + 2, offset + 2),
        #}
        #offset = 10
        #beacon = {
        #    Cell(offset + 1, offset + 1),
        #    Cell(offset + 2, offset + 1),
        #    Cell(offset + 1, offset + 2),
        #    Cell(offset + 4, offset + 3),
        #    Cell(offset + 3, offset + 4),
        #    Cell(offset + 4, offset + 4),
        #}
        #self.cells = glider | beacon
